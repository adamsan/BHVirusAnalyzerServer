...
public class CompetitioinResultArrayListDao implements DAO<CompetitionResult> {

    public static CompetitioinResultArrayListDao INSTANCE = new CompetitioinResultArrayListDao();

    private CompetitioinResultArrayListDao() {}
